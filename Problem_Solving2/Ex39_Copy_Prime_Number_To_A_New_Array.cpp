...
void CopyPrimeElementToNewArray(int arrSource[100], int arrDestination[100], int arrLength, int& arrDestinationLength)
{
	int i = 0;
	while (i < arrLength)
	{
...
int main()
{
	...
	CopyPrimeElementToNewArray(arr1, arr2, arrLength, arrDestinationLength);
