...
bool IsDateWithinAPeriod(stPeriod Period1, stDate Date)
{
...
int main()
{
    ...
    if (IsDateWithinAPeriod(Period1, Date))
        cout << "\nYes, Date is Within the Periods\n";
    else
        cout << "\nNo, Date is not Within the Periods\n";
